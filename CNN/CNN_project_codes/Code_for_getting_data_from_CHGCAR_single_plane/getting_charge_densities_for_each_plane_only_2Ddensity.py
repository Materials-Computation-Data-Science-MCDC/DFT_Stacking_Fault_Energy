...
def getting_charge_densities_from_CHGCAR(str_id, direction):
    ...
    for value in z_values:
        ...
        #charge_density_for_all_planes.append(density2D)
        #print(str(np.shape(density2D_pd)) + ' ' +  str(np.shape(yarray_pd)))
        #print(counter)s
